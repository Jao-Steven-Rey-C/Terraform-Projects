...
2. When downloading a project or an exercise folder, always run "terraform init" in said folder directory's PowerShell first to initialize provider.tf configurations and public modules before applying the configurations into your AWS console.
